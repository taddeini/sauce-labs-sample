exports.config = {
    ...
    // Settings to help with the timeout issues.
    ...
    // WebDriver's default behavior is to create screenshots with timestamps which is not ideal.
    // ... so we use the afterTest hook to write a sanely-named screenshot file instead.
    screenshotPath: './src/errors/',
    ...
    // See https://github.com/webdriverio/webdriverio/issues/269 for more info
